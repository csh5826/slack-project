...
function App() {
  ...
  return (
    ...
    <FormControl as="textarea" aria-label="text area" /><InputGroup.Append><InputGroup.Text onClick={postMessage}>Post</InputGroup.Text></InputGroup.Append></InputGroup></div>
    </Col>
    </Row>
  </Container>
